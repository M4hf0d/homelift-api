...
urlpatterns = [
    ...
    # product-subcategory
    path(
        "categories/<int:pk>/subcategory/",
        SubCategoryListAPIView.as_view(),
        name="sub-category-list",
    ),
    path(
        "categories/<int:pk>/subcategory-create/",
        SubCategoryCreateAPIView.as_view(),
        name="sub-category-create",
    ),
    path(
        "categories/subcategory/<int:pk>/",
    ...
    path(
        "products/<int:pk>/comments-create/",
        CommentsCreateAPIView.as_view(),
        name="comments-create",
    ),
    path(
        "products/comments/<int:pk>/",
        CommentsRetrieveUpdateDestroyAPIView.as_view(),
        name="comments-detail",
    ),
    # product-images
    path("products/<int:pk>/images/", ImagesListAPIView.as_view(), name="images-list"),
    path(
        "products/<int:pk>/images-create/",
        ImagesCreateAPIView.as_view(),
        name="images-create",
    ),
    path(
        "products/images/<int:pk>/",
        ImagesRetrieveUpdateDestroyAPIView.as_view(),
        name="images-detail",
    ),
    # product-rating
    path("products/<int:pk>/rating/", RatingListAPIView.as_view(), name="rating-list"),
    path(
        "products/<int:pk>/rating-create/",
        RatingCreateAPIView.as_view(),
        name="rating-create",
    ),
    path(
        "products/rating/<int:pk>/",
        RatingRetrieveUpdateDestroyAPIView.as_view(),
        name="rating-detail",
    ),
]
